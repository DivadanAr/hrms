...
export default function ModalDeleteDepartemen({
  isOpen,
  data,
  onClose,
  onSuccess,
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        onClose();
        onSuccess(`Departemen "${data?.nama_departemen}" berhasil dihapus.`);
      }
    } catch {
      onError("Gagal menghapus departemen. Coba lagi.");
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="px-5 py-5 space-y-3">
          ...
          <p className="text-sm text-gray-600">
            Apakah kamu yakin ingin menghapus departemen ini?
          </p>
        </div>
