...
export default function ModalTambahKaryawan({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      handleClose();
      onSuccess("Karyawan berhasil ditambahkan.");
    } catch {
      onError("Gagal menambahkan karyawan. Coba lagi.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const selectClass = (field: keyof typeof initialForm) =>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5 col-span-2">
                ...
                <textarea
                  ...
                  disabled={loading}
                  rows={2}
                  className="w-full px-3 py-2 text-sm rounded-lg border border-gray-200 focus:border-emerald-400 outline-none transition-colors bg-white text-gray-800 placeholder-gray-400 resize-none disabled:opacity-60"
                />
              </div>
            </div>
          </div>
